...
class HomeView(EcomMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        url_id = self.request.GET.get('category')
        if url_id:
            products = Product.objects.filter(category = url_id)
        else:
    ...
    def form_valid(self, form):
        ...
        if cart_id:
            ...
            if pm == "Cash On Delivery":
                ...
                order = form.save()
                return redirect(reverse("ecomapp:cashonrequest") + "?o_id=" + str(order.id))
            # if pm == "Cash On Delivery":
            #     return redirect(reverse("ecomapp:cashonrequest") + "?o_id=" + str(order.id))
            else:
                if pm == "Paytm":
                    return redirect(reverse("ecomapp:paytmrequest"))
                elif pm == "Debit/Credit Card":
                    return redirect(reverse("ecomapp:cardrequest"))
        else:
            return redirect("ecomapp:home")
        return super().form_valid(form)

class CashonRequestView(View):
